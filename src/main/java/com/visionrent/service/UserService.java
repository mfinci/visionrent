...
public class UserService {
	 ...
	 * BURA ANLATILACAK
	 * 
	 * public Page<UserDTO> getUserPage(Pageable pageable) { Page<User> userPage =
	 * userRepository.findAll(pageable); Page<UserDTO> userPageDTO =
	 * userPage.map(userMapper::userToUserDTO); return userPageDTO; }
	 */
	...
	public void updatePassword(UpdatePasswordRequest updatePasswordRequest) {
		...
		/*
		 * transactional açıklaması için eklendi if(true) { throw new
	...
	// olarak ele alınmasını sağlar, bir veya daha fazla SQL işluseremi tek bir
	// işlem gibi ele alınır.
